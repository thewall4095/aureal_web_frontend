...
export class MetatagsService {
  ...
  defaultTags(){
    ...
    this.metaTagService.addTags([
      ...
      { name: 'twitter:url', content: 'https://aureal.one' }, //
      ...
      { property: 'og:image:secure_url', content: 'https://aurealbucket.s3.us-east-2.amazonaws.com/aureal_full_dark.png' },
      { property: 'og:image:width', content: '200' },
      { property: 'og:image:height', content: '55' },
      { name: 'twitter:title', content: 'Aureal - The podcast platform that pays you' },
      { name: 'twitter:description', content: 'Monetise your podcasts easily without ads or sponsorships on decentralised platform.' },
      { name: 'twitter:image', content: 'https://aurealbucket.s3.us-east-2.amazonaws.com/aureal_full_dark.png' },
